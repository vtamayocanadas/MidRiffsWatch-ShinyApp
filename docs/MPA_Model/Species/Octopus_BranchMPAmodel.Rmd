...
TO DO:
add N0, K is not the starting value
  b is N0
  k/100 becuase its total and there are 100 cells
  make sure to use k that is multiplied by 1000
change the r and k estiamtes to values from the priors table
```{r}
